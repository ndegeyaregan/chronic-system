  ...
  void _initPedometer() {
    ...
    try {
      _stepSub = Pedometer.stepCountStream.listen(
        (StepCount event) {
          if (!mounted) return;
          setState(() { _liveSteps = event.steps; _pedAvailable = true; });
        },
        onError: (_) {},
        cancelOnError: false,
      );
