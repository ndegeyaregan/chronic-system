                ...
                children: [
                  ClipRRect(
                    ...
                    child: AspectRatio(
                      aspectRatio: 16 / 9,
                      child: kIsWeb
                          ? _WebThumb(videoId: w['videoId']!, category: cat)
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(children: [
                          ...
                          const Spacer(),
                          GestureDetector(
                            onTap: () => launchUrl(Uri.parse('https://www.youtube.com/watch?v=${w['videoId']}'),
...
// ── Web thumbnail fallback ────────────────────────────────────────────────────

class _WebThumb extends StatelessWidget {
  final String videoId;
  final String category;
  const _WebThumb({required this.videoId, required this.category});
