                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          // Health ring row
                          Builder(builder: (_) {
                            final headerScore = _computeHealthScore(vitState, medsState, conditions);
                            final headerScoreInt = headerScore.round();
                            return Row(
                            children: [
                              // Ring
                              SizedBox(
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    CustomPaint(size: const Size(80, 80),
                                      painter: _RingPainter(headerScore / 100,
                                        Colors.white.withValues(alpha: 0.15),
                                        Colors.white, strokeWidth: 6)),
                                    Column(
                                      mainAxisSize: MainAxisSize.min,
                                      children: [
                                        Text('$headerScoreInt', style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w800, height: 1)),
