...
const CSV_TEMPLATE = `member_number,first_name,last_name,email,phone,plan,conditions,date_of_birth\nSAN001,John,Doe,john@example.com,0821234567,Gold,Diabetes,1985-06-15\n`;
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div style={{ background: '#fff', borderRadius: '12px', boxShadow: '0 1px 4px rgba(0,0,0,0.07)', overflow: 'hidden' }}>
        {isLoading ? <Spinner /> : <Table columns={columns} data={members} emptyMessage="No members found." />}
      </div>
        ...
        >
          ...
          >
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '16px' }}>
              ...
              <Input label="Plan" name="plan" register={register} error={errors.plan} placeholder="Gold" />
              ...
              <Input label="ID Number" name="id_number" register={register} error={errors.id_number} placeholder="National ID or passport" />
