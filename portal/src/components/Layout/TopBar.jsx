...
const TITLES = {
  ...
  '/members': 'Members',
  '/hospitals': 'Hospitals',
  '/institution-price-lists': 'Instution Price List',
  '/institution-price-lists/all': 'All Price Lists',
  '/service-cost-comparison': 'Service Cost Comparison',
  '/appointments': 'Appointments',
  '/medications': 'Medications',
  '/reimbursements': 'Reimbursement Requests',
  '/card-reprints': 'Card Reprint Requests',
  '/member-logins': 'Member Login Activity',
  '/schemes': 'Schemes',
